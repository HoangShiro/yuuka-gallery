// --- MODIFIED FILE: plugins/slot-machine/static/js/constants.js ---
// Yuuka: Central configuration for the Slot Machine plugin
...
export const GAME_CONFIG = {
    ...
    CARD_WIDTH: 150,
    CARD_HEIGHT: 200,
    CARD_MARGIN: 16, // var(--spacing-4)
    MOBILE_CARD_SCALE: 0.4,
};
...
export const SPECIAL_CARD_CONFIGS = [
    { id: 'respin', category: 'respin', icon: 'autorenew', badgeLabel: null, respins: 1, maxPerSpin: 2, chance: 0.8 },
    { id: 'reverse_spin', category: 'reverse-spin', icon: 'u_turn_left', badgeLabel: null, maxPerSpin: 1, chance: 0.8 },
    ...
    { id: 'multiplier_x5', category: 'multiplier', icon: 'filter_5', badgeLabel: 'x5', multiplier: 5, maxPerSpin: 1, chance: 0.05 },
    ...
    { id: 'clear', category: 'clear', icon: 'ink_eraser', badgeLabel: 'CLR', maxPerSpin: 1, chance: 0.2 },
    // YUUKA: Them cac loai the thuong diem moi
